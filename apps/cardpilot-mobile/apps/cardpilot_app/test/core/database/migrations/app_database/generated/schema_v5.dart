...
class MerchantBranchesCache extends Table
    with TableInfo<MerchantBranchesCache, MerchantBranchesCacheData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MerchantBranchesCache(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  MerchantBranchesCacheData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return MerchantBranchesCacheData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  MerchantBranchesCache createAlias(String alias) {
    return MerchantBranchesCache(attachedDatabase, alias);
  }
...
class MerchantBranchesCacheData extends DataClass
    implements Insertable<MerchantBranchesCacheData> {
  final String id;
  final String name;
  final String nameNormalized;
  final String? locationText;
  final int datasetVersion;
  const MerchantBranchesCacheData({
    required this.id,
    required this.name,
  ...
  factory MerchantBranchesCacheData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  MerchantBranchesCacheData copyWith({
    String? id,
    String? name,
    String? nameNormalized,
    Value<String?> locationText = const Value.absent(),
    int? datasetVersion,
  }) => MerchantBranchesCacheData(
    id: id ?? this.id,
    name: name ?? this.name,
  ...
  MerchantBranchesCacheData copyWithCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('MerchantBranchesCacheData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MerchantBranchesCacheData &&
          other.id == this.id &&
          other.name == this.name &&
...
class MerchantBranchesCacheCompanion
    extends UpdateCompanion<MerchantBranchesCacheData> {
  final Value<String> id;
  final Value<String> name;
  ...
  MerchantBranchesCacheCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       nameNormalized = Value(nameNormalized);
  static Insertable<MerchantBranchesCacheData> custom({
    Expression<String>? id,
    Expression<String>? name,
...
class LocalMerchantMccContributions extends Table
    with
        TableInfo<
          ...
          LocalMerchantMccContributionsData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LocalMerchantMccContributions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  LocalMerchantMccContributionsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LocalMerchantMccContributionsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  LocalMerchantMccContributions createAlias(String alias) {
    return LocalMerchantMccContributions(attachedDatabase, alias);
  }
...
class LocalMerchantMccContributionsData extends DataClass
    implements Insertable<LocalMerchantMccContributionsData> {
  final String id;
  final String profileId;
  final String merchantServerId;
  ...
  final int createdAtMs;
  final int updatedAtMs;
  const LocalMerchantMccContributionsData({
    required this.id,
    required this.profileId,
    required this.merchantServerId,
  ...
  factory LocalMerchantMccContributionsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  LocalMerchantMccContributionsData copyWith({
    String? id,
    String? profileId,
    String? merchantServerId,
  ...
  LocalMerchantMccContributionsData copyWithCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('LocalMerchantMccContributionsData(')
          ..write('id: $id, ')
          ..write('profileId: $profileId, ')
          ..write('merchantServerId: $merchantServerId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LocalMerchantMccContributionsData &&
          other.id == this.id &&
          other.profileId == this.profileId &&
          other.merchantServerId == this.merchantServerId &&
...
class LocalMerchantMccContributionsCompanion
    extends UpdateCompanion<LocalMerchantMccContributionsData> {
  final Value<String> id;
  final Value<String> profileId;
  final Value<String> merchantServerId;
  ...
  LocalMerchantMccContributionsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAtMs = Value(createdAtMs),
       updatedAtMs = Value(updatedAtMs);
  static Insertable<LocalMerchantMccContributionsData> custom({
    Expression<String>? id,
    Expression<String>? profileId,
    Expression<String>? merchantServerId,
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final MerchantBranchesCache merchantBranchesCache =
      MerchantBranchesCache(this);
  late final LocalUserCards localUserCards = LocalUserCards(this);
  late final LocalMerchantMccContributions localMerchantMccContributions =
      LocalMerchantMccContributions(this);

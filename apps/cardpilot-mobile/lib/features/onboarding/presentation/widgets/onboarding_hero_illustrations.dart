...
class _SkyPainter extends CustomPainter {
  ...
  void _cloud(Canvas canvas, Offset c, double width, Paint paint) {
    ...
    final path = Path()
      ..addOval(
        Rect.fromCenter(center: Offset(c.dx, c.dy + 8), width: width, height: h),
      )
      ..addOval(
        Rect.fromCenter(
...
class _PlanePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Body shadow
    canvas.drawOval(
      Rect.fromCenter(center: center + const Offset(0, 10), width: 190, height: 86),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromCenter(center: center + const Offset(42, 22), width: 92, height: 26),
    ...
    // White top shell
    canvas.drawOval(
      Rect.fromCenter(center: center + const Offset(0, -10), width: 200, height: 78),
...
class _CardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final chip = RRect.fromRectAndRadius(
      Rect.fromCenter(center: c + const Offset(-58, -14), width: 44, height: 34),
      const Radius.circular(10),
    );
    canvas.drawRRect(chip, Paint()..color = Colors.white.withValues(alpha: 0.85));
    canvas.drawRRect(
      chip,
      Paint()
        ..color = Colors.white.withValues(alpha: 0.18)
